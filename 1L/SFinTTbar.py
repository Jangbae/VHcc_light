...
# fileName = "/store/user/lmastrol/VHccPostNano2016_V4_mc/ST_tW_top_5f_inclusiveDecays_13TeV-powheg-pythia8_TuneCUETP8M1/RunIISummer16NanoAOD-PUMoriond84/180812_185052/0000/tree_1.root"
fileName = "/store/user/lmastrol/VHcc_2016V4bis_Nov18/TT_TuneCUETP8M2T4_13TeV-powheg-pythia8/arizzi-RunIIMoriond17-DeepAndR139/181118_101427/0000/tree_94.root"
# fileName = /eos/cms/store/user/lmastrol/VHccPostNano2016_V4_mc/ST_tW_top_5f_inclusiveDecays_13TeV-powheg-pythia8_TuneCUETP8M1/RunIISummer16NanoAOD-PUMoriond84/180812_185052/0000/tree_1.root
...
iFile = TFile.Open("/eos/cms/"+fileName)
#iFile = TFile.Open("/pnfs/desy.de/cms/tier2/"+fileName)
...
# oFile = TFile('/afs/desy.de/user/x/xcoubez/Autumn18/CMSSW_10_2_0_pre3/src/VHcc_light/SF_slttbar/outputfiles/'+label+'.root','RECREATE')
oFile = TFile('/eos/cms/store/user/jblee/Hcc/WlvHcc/'+version+'/'+channel+'/tree_'+label+'.root','RECREATE')
# oFile = TFile('/eos/cms/store/user/xcoubez/SFctagging/'+label+'.root','RECREATE')
...
#     if count>1000: break
    ...
    if not 'Single' in channel and not 'Double' in channel:
        hJets_CvsB       = sorted(zip( jetList, jet_CvsB_List, jet_CvsL_List, jet_FL_List ), key = lambda pair : pair[2], reverse=False)[0:3]
...
###########################################################################
    if 'Single' in channel or 'Double' in channel:
        hJets_CvsB       = sorted(zip(jetList,jet_CvsB_List,                       ), key = lambda pair : pair[1], reverse=False)[0:3]
    # was reverse = True
    ...
    Jet0_CvsL[0]         = hJets_CvsB[0][1]
    Jet0_CvsB[0]         = hJets_CvsB[0][2]
    ...
    AddJet1_CvsL[0]      = hJets_CvsB[1][1]
    AddJet1_CvsB[0]      = hJets_CvsB[1][2]
    ...
    AddJet2_CvsL[0]      = hJets_CvsB[2][1]
    AddJet2_CvsB[0]      = hJets_CvsB[2][2]

    #print "Jet 4 - Pt: ", hJets_CvsB[3][0].Pt(), "  Eta: ", hJets_CvsB[3][0].Eta(), "  Phi: ", hJets_CvsB[3][0].Phi(), "  CvsL?: ", hJets_CvsB[3][1], "  CvsB? or flavour?: ", hJets_CvsB[3][3]
    #AddJet3_pt[0]        = hJets_CvsB[3][0].Pt()
    #AddJet3_eta[0]       = hJets_CvsB[3][0].Eta()
    #AddJet3_phi[0]       = hJets_CvsB[3][0].Phi()
    #AddJet3_CvsL[0]      = hJets_CvsB[3][1]
    #AddJet3_CvsB[0]      = hJets_CvsB[3][2]

    if not 'Single' in channel and not 'Double' in channel:
        print "Jet 1 - hadronFLavour: ", hJets_CvsB[0][3], "  CvsL?: ", hJets_CvsB[0][1], "  CvsB? or flavour?: ", hJets_CvsB[0][2]
        print "Jet 2 - hadronFLavour: ", hJets_CvsB[1][3], "  CvsL?: ", hJets_CvsB[1][1], "  CvsB? or flavour?: ", hJets_CvsB[1][2]
        print "Jet 3 - hadronFLavour: ", hJets_CvsB[2][3], "  CvsL?: ", hJets_CvsB[2][1], "  CvsB? or flavour?: ", hJets_CvsB[2][2]
        #print "Jet 4 - hadronFLavour: ", hJets_CvsB[3][3], "  CvsL?: ", hJets_CvsB[3][1], "  CvsB? or flavour?: ", hJets_CvsB[3][2]
        Jet0_hadronFlavour[0] = hJets_CvsB[0][3]
        AddJet1_hadronFlavour[0] = hJets_CvsB[1][3]
        AddJet2_hadronFlavour[0] = hJets_CvsB[2][3]
        #AddJet3_hadronFlavour[0] = hJets_CvsB[3][3]
